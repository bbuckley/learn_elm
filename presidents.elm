module Presidents exposing (Person, presidents)
...
-- import Dict
-- import Dict
-- x : List Person -> Dict.Dict Int Person
-- x presidents =
--     Dict.fromList
--         [ ( 1, Person "George Washington" 1732 "Westmoreland County" "Virginia" )
--         , ( 3, Person "John Adams" 1735 "Braintree" "Massachusetts" )
--         , ( 2, "Thomas Jefferson" 1743 "Shadwell" "Virginia" )
--         ]
