...
--     in
--     [ radioButton [] Red xx
--     , radioButton [] Green xx
--     , Html.label [ Attributes.for (toString Blue) ] [ Html.text (toString Blue) ]
--     , radioButton [] Blue xx
--     , Html.label [ Attributes.for (toString Black) ] [ Html.text (toString Black) ]
--     , radioButton [] Black xx
--     ]
...
view currentColor =
    let
        c =
            comboBox [] toString [ Red, Green, Blue, Black ] currentColor
    in
    Html.div []
        [ Html.div [] [ c, Html.text (toString currentColor) ]
        , Html.p [] [ c ]
        , Html.p [] [ c ]

        -- , Html.p [] [ comboBox [] toString [ Hearts, Spades, Clubs ] currentSuit ]
        , Html.div []
            [ radioButton [] Red currentColor
            , radioButton [] Green currentColor
            , Html.label [ Attributes.for (toString Blue) ] [ Html.text (toString Blue) ]
            , radioButton [] Blue currentColor
            , Html.label [ Attributes.for (toString Black) ] [ Html.text (toString Black) ]
            , radioButton [] Black currentColor
            ]

        -- , Html.div []
        -- [ x ]
        , Html.text (toString currentColor)
        ]
